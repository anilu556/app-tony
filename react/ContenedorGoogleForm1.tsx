...
const ContenedorGoogleForm1 = ()=> {
  ...
  const getCodigoFormulario = async () => {
    ...
    try {
      ...
      console.log('Ocurrio un error al obtener codigos', error)
      return false
    }

    usarCodigo = codigosEmbeb[0].CodigoFormulario
...
export default ContenedorGoogleForm1
